...
func (requ *AlipayTradeAppPayRequest) GetAPImethodName() string {
	return "alipay.trade.app.pay"
}

// IsNeedEncrypt IsNeedEncrypt
func (requ *AlipayTradeAppPayRequest) IsNeedEncrypt() bool {
	return false
}

// IsNeedBizContent IsNeedBizContent
func (requ *AlipayTradeAppPayRequest) IsNeedBizContent() bool {
	return true
}